...
export default defineConfig({
  ...
  vite: {
    define: {
      "import.meta.env.PUBLIC_MY_ALGOLIA_APP_ID": JSON.stringify(
        process.env.MY_ALGOLIA_APP_ID
      ),
      "import.meta.env.PUBLIC_MY_ALGOLIA_SEARCH_API_KEY": JSON.stringify(
        process.env.MY_ALGOLIA_SEARCH_API_KEY
      ),
